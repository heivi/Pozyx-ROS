#include "Pozyx-Linux-library/Pozyx.h"
#include "Pozyx-Linux-library/Pozyx_definitions.h"
#include "Pozyx-Linux-library/helpers.hh"
...
void PozyxROS::update() {
	...
	while (ros::ok()) {
		...
		if (Pozyx.waitForFlag(POZYX_INT_STATUS_IMU, 300, 0))
		{
